...
<div class="page-content-wrapper ">
    ...
    <div class="container-fluid">
        ...
        <form action="{{route('owner_post')}}" method="POST">
        ...
        <div class="card">
            <div class="card-body">
                    ...
                    <div class="form-group-row">
                        ...
                        <div class="col-sm-10">
                            <input required class="form-control" name="client_client_id" type="client" placeholder="0000045" id="example-search-input">
                        </div>
                    </div>
